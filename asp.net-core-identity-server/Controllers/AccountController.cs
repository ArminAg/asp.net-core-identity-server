...
using asp.net_core_identity_server.Attributes;
using asp.net_core_identity_server.Services;
using asp.net_core_identity_server.ViewModels.Account;
using asp.net_core_identity_server.Models;

namespace asp.net_core_identity_server.Controllers
{
    /// <summary>
    ...
    public class AccountController : Controller
    {
            ...
            TestUserStore users = null)
        {
            ...
            _users = users ?? new TestUserStore(Config.GetOidcUsers());
